...
\begin{actortable}
	...
	\addnumbereddoublerow{OUT}{\hypertarget{actCoordinator.outactCoordinator.oeSubmitQualitySurvey}
			{\msrcode{oeSubmitQualitySurvey(AdtSurveyID:dtSurveyID, Aresult:ptString):ptBoolean}}}
			{sent to indicate that a quality survey is submitted.}
